...
int main() {
	...
	if ((instance = table_Init(styleDefault, false)) != NULL) {
	...
	if ((instance = table_Init(styleCompact, false)) != NULL) {
	...
	if ((instance = table_Init(styleCompact, true)) != NULL) {
		table_AddRow(instance, "##\tTask\tTime");
		table_AddRow(instance, "01\tWake up!\t0630");
		table_AddRow(instance, "03\tWrite Code!\t0730");
		table_AddRow(instance, "04\tSleep!\t2200");
	...
	if ((instance = table_Init(styleWindows, true)) != NULL) {
		table_AddRow(instance, "##\tTask\tTime");
		table_AddRow(instance, "01\tWake up!\t0630");
		table_AddRow(instance, "03\tWrite Code!\t0730");
		table_AddRow(instance, "04\tSleep!\t2200");
	...
	if ((instance = table_Init(styleWindows, false)) != NULL) {
		table_AddRow(instance, "##\tTask\tTime");
		table_AddRow(instance, "01\tWake up!\t0630");
		table_AddRow(instance, "03\tWrite Code!\t0730");
		table_AddRow(instance, "04\tSleep!\t2200");
